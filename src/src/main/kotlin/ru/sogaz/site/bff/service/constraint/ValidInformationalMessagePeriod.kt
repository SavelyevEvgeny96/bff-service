...
class InformationalMessagePeriodValidator :
    ConstraintValidator<ValidInformationalMessagePeriod, InformationalMessagePeriodAware> {
    override fun isValid(
        ...
        if (!valid) {
            ...
            context.buildConstraintViolationWithTemplate("{informational.message.display-to.after-display-with}")
